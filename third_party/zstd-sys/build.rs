...
fn compile_zstd_cmake() {
    ...
    {
        let mut seekable = cbuild::Build::new();
        seekable
            .include("zstd/lib")
...
#[cfg(not(feature = "cmake"))]
fn compile_zstd() {
    let mut config = cbuild::Build::new();
