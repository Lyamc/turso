...
pub type printfunc =
    unsafe extern "C" fn(arg1: *mut PyObject, arg2: *mut crate::pyport::FILE, arg3: c_int) -> c_int;
...
extern_libpython! {
    ...
    pub fn PyObject_Print(o: *mut PyObject, fp: *mut crate::pyport::FILE, flags: c_int) -> c_int;
